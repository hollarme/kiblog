    ...
    with st.container(border=True):
        with st.status("", expanded=True) as status:
            ...
            if interface == 'Table Interface':
                ...
                amount = st.number_input("Enter the worth of the expenses", value=0)
                ...
                st.session_state['expx_list_table'] = {'Category': category, 'Expenses': expenses, 'Type': type, 'Date':st.session_state['dt'], 'Note': note, "Amount": amount, 'Direction': direction, 'Date': dt}
