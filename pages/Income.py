            ...
            if interface=='Table Interface':
                ...
                st.session_state["inc_data_df"] = st.data_editor(
                    ...
                    column_config={
                        ...
                        "Units":  st.column_config.NumberColumn(required=True),
                ...
                st.session_state['pro_inc_table'] = {'Category': category, 'Product': product, 'Type': type, 'Weight(kg)': weight,'Units': units, 'Date':st.session_state['dt'], 'Note': note, "Unit Price(N)": unit_price, "Total Price(N)": total_price, "Paid": paid, 'Date':dt}
